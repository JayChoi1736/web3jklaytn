...
public class Application {
        ...
        private void run() throws Exception {
                ...
                System.out.println("Nonce : " + getNonce(cred_test.getAddress()));
                ...
                // byte[] signedMessage1 = KlaytnTransactionEncoder.signMessage(raw, chainId,
                // cred_test);
                // byte[] signedMessage = KlaytnTransactionEncoder.signMessage(raw, chainId,
                // cred_multi2);
